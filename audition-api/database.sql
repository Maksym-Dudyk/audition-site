...
INSERT INTO `feedback` VALUES (1,'Дуже задодолений','Все чудово. У компанії мені надали корисні поради та рекомендації, які допомогли моєму бізнесу рости.','2020-04-05',1,1), (2,'Буду повертатись ще!','Професіоналізм, який проявляють працівники цієї компанії, дійсно вражає. Вони завжди готові допомогти та відповісти на всі запитання.','2021-03-22',4,3), (3,'Рекомендую!','Дякую за чудову роботу! Якість послуг на висоті, а співпраця з компанією - це справжнє задоволення.','2022-01-01',5,2);
